...
const NavbarItem: FC<Props> = ({ title, description, image, children }) => {
    ...
    <div className="">
      ...
      {showSubs && (
        <div
          ...
          className="absolute mt-5 bg-white shadow-xl z-10 w-full left-0 x-padding right-0 flex justify-between"
        >
